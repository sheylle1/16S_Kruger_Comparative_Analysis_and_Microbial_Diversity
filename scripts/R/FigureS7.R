...
c
ggsave("outputs/figures/FigS7_1.png", width = 15, height = 6, dpi = 600)
...
nr
ggsave("outputs/figures/FigS7_2.png", width = 20, height = 6, dpi = 600)
...
r
ggsave("outputs/figures/FigS7_3.png", width = 10, height = 6, dpi = 600)
...
for(ext in c("png","pdf","tiff")){
  ggsave(
    filename = paste0("outputs/Final/FigureS7.", ext),
