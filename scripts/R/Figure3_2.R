...
ggsave("outputs/figures/Fig3_2.png", plot = abundance_plot, width = 20, height = 10, dpi = 600)
ggsave("outputs/figures/Fig3_2.tiff", plot = abundance_plot, width = 20, height = 10, dpi = 600)