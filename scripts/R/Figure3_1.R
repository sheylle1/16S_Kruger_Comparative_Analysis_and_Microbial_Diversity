...
final_data$Diet_type <- factor(abundance_family_rel$Diet_type, levels = c("Carnivore", "Non-Ruminant", "Ruminant"))
...
ggsave("outputs/figures/Fig3_1.png", 
       plot = abundance_plot, width = 20, height = 10, dpi = 600)
ggsave("outputs/figures/Fig3_1.tiff", 
       plot = abundance_plot, width = 20, height = 10, dpi = 600)
